...
var positions = [
  ...
  { title: '마포구청 배움터교육장<br>(지하1층)', address: '서울특별시 월드컵로212', iwContent: '<a href="https://www.xn--2z1bw8k1pjz5ccumkb.kr/edc/crse/plcdtl.do?&sch_edc_place_id=20210002134" style="color:blue" target="_blank">교육신청</a>' },
  ...
  { title: '서대문구평생학습관<br>융복합인재교육센터', address: '서울특별시 서대문구 연희로36길 49', iwContent: '<a href="https://www.xn--2z1bw8k1pjz5ccumkb.kr/edc/crse/plcdtl.do?&sch_edc_place_id=20190000098" style="color:blue" target="_blank">교육신청</a>' },
  ...
  //은평구
  { title: '은평문화예술회관<br>(지하1층 컴퓨터실)', address: '서울 은평구 녹번로 16', iwContent: '<a href="https://www.xn--2z1bw8k1pjz5ccumkb.kr/edc/crse/plcdtl.do?&sch_edc_place_id=20190000193" style="color:blue" target="_blank">교육신청</a>' },
  ...
  { title: '응암정보도서관<br>(2~3층)', address: '서울특별시 은평구 가좌로 179', iwContent: '<iwContent: href="https://www.xn--2z1bw8k1pjz5ccumkb.kr/edc/crse/plcdtl.do?&sch_edc_place_id=20190000198" style="color:blue" target="_blank">교육신청</a>' },
 ...
 { title: '한국복지정보통신협의회(강북)<br>(KT미아빌딩 별관2동 제1강의실)', address: '서울특별시 강북구 솔매로50길 43',
    iwContent:
  ...
  { title: '노원구 평생교육원 장미실습장<br>(6단지 종합상가내지하1층장미실습장)', address: '서울특별시 노원구 섬밭로196',
    iwContent:
  ...
  { title: '창동주공19단지A 경로당<br>(1층)', address: '서울특별시 도봉구 노해로70길 54',
    iwContent:
  ...
  { title: '도봉동어르신복지관<br>(4층컴퓨터실)', address: '서울특별시 도봉구 도봉로169가길 52' ,
    iwContent:
  ...
  { title: '구립동대문장애인종합복지관<br>(다사랑행복센터 2층)', address: '서울특별시 동대문구 청계천로 521',
    iwContent:
...
{ title: '장위실버복지센터', address: '서울특별시 성북구 한천로 708',
  ...
  //3권역
  //강동구
  { title: '서울시민대학 동남권캠퍼스<br>(4층 교육장 (소프트웨어3실 & 스마트강의실))', address: '서울특별시 강동구 고덕로 399',
    iwContent:
  ...
  { title: '강동마을미디어지원센터<br>(6층)', address: '서울특별시 강동구 올림픽로 752' ,
    iwContent:
  ...
  { title: '강일동 스마트복지센터<br>(푸르내 102동 302호)', address: '서울 강동구 상일로 12길 95',
    iwContent:
      '<a href="" style="color:red" target="_blank">교육신청</a>'
 },
  { title: '시립강동노인종합복지관<br>(1층)', address: '서울특별시 강동구 동남로71길 32-5' ,
    iwContent:
  ...
  { title: '강동구립해공도서관<br>(3층)', address: '서울특별시 강동구 올림픽로 702',
    iwContent:
  ...
  { title: '성내종합사회복지관<br>(4층)', address: '서울특별시 강동구 성안로 13길 56',
    iwContent:
  ...
  { title: '강동 또바기작은도서관<br>(관리동 2층)', address: '서울 강동구 아리수로98길 25' ,
    iwContent:
  ...
  { title: '고덕3단지 SH작은도서관<br>(고덕리엔파크3단지아파트 315동 1층)', address: '서울 강동구 상일로 74',
    iwContent:
...
{ title: '광진 이튼타워 경로당', address: '서울특별시 광진구 능동로 18' ,
  ...
  { title: '광진정보도서관<br>(2층 교육실)', address: '서울특별시 광진구 아차산로78길 90',
    iwContent:
  ...
  { title: '자양종합사회복지관<br>(4층 컴퓨터실)', address: '서울 광진구 자양번영로 35',
    iwContent:
  ...
  { title: '자양한강도서관<br>(3층 컴퓨터실)', address: '서울특별시 광진구 뚝섬로52길 66' ,
    iwContent:
  ...
  { title: '중곡문화체육센터 도서관<br>(3층 소강의실)', address: '서울특별시 광진구 능동로 433',
    iwContent:
  ...
  { title: '성동구립금호도서관<br>(4층 교육실)', address: '서울특별시 성동구 난계로 20',
    iwContent:
  ...
  { title: '성동구립 사근동노인복지센터<br>(2층 교육실)', address: '서울특별시 성동구 사근동길 37',
    iwContent:
  ...
  { title: '성동장애인종합복지관<br>(2층 교육실)', address: '서울특별시 성동구 청계천로 506',
    iwContent:
  ...
  { title: '성동구청 5층 배움터교육장<br>(5층 정보화교육장)', address: '서울특별시 성동구 고산자로 270',
    iwContent:
  ...
  { title: '왕십리 도선동 주민센터3층 배움터교육장<br>(노인복지관 공공복합청사 3층)', address: '서울특별시 성동구 마장로 141',
    iwContent:
  ...
  { title: '효창종합사회복지관<br>(2층)', address: '서울특별시 용산구 효창원로 146-12',
    iwContent:
  ...
  { title: '청파노인복지관<br>(4층)', address: '서울특별시 용산구 청파로83길 26',
    iwContent:
  ...
  { title: '참나무 배움터<br>(용산제일교회내 참나무방과후교실 1층)', address: '서울 용산구 새창로12길 11-18',
    iwContent:
  ...
  { title: '용산시각장애인연합회<br>(3층 시각장애인협회 정보화교육장)', address: '서울 용산구 서빙고로 245',
    iwContent:
  ...
  { title: '신내2동 동주민센터 IT융합교육장<br>(관상복합청사지하1층)', address: '서울특별시 중랑구 봉화산로 190',
    iwContent:
  ...
  { title: '신내경로복지센터<br>(3층 정보검색실)', address: '서울특별시 중랑구 망우로65길 20',
    iwContent:
  ...
  { title: '미디어센터 관악<br>(6층)', address: '서울특별시 관악구 남부순환로 1491',
    iwContent:
  ...
  { title: '흑석동 주민센터<br>(2층)', address: '서울특별시 동작구 흑석한강로 11' ,
    iwContent:
  ...
  { title: '시립동작노인종합복지관<br>(지하1층)', address: '서울특별시 동작구 상도로 11길 7',
    iwContent:
  ...
  { title: '시립발달장애인복지관<br>(2층 207호)', address: '서울특별시 동작구 여의대방로20나길 39',
    iwContent:
  ...
  { title: '유한양행 교육장<br>(9층 전산교육장)', address: '서울특별시 동작구 노량진로74',
    iwContent:
  ...
  { title: '동작구장애인가족지원센터<br>(5층)', address: '서울특별시 동작구 보라매로5가길 16' ,
    iwContent:
  ...
  { title: '서초IT배움센터<br>(양재역 환승주차장 5층)', address: '서울특별시 서초구 강남대로221',
    iwContent:
  ...
  //송파구
  { title: '올림픽수영장 문화센터<br>(2층)', address: '서울특별시 서초구 서초대로59',
    iwContent:
  ...
  { title: '마천종합사회복지관<br>(3층 교육장)', address: '서울특별시 송파구 마천로 65길 4' ,
    iwContent:
  ...
  { title: '송파종합사회복지관<br>(2층)', address: '서울특별시 송파구 오금로51길 34' ,
    iwContent:
  ...
  { title: '송파실벗뜨락<br>(6층)', address: '서울특별시 송파구 백제고분로 42길 5',
    iwContent:
  ...
  { title: '헬리오시티APT경로당<br>(1~5단지 경로당)', address: '서울특별시 송파구 송파대로 345',
    iwContent:
  ...
  //강남구
  { title: '강남노인종합복지관<br>(4층)', address: '서울특별시 강남구 삼성로 628',
    iwContent:
  ...
  { title: '강서구립곰달래어르신복지센터<br>(3층)', address: '서울특별시 강서구 강서로 5길 50',
    iwContent:
  ...
  { title: '강서구립봉제산어르신복지센터<br>(강서구보건소 화곡분소 3층)', address: '서울특별시 강서구 초록마을로 15길 12',
    iwContent:
  ...
  { title: '에코미래학습코칭센터<br>(SB타워 511호)', address: '서울특별시 강서구 마곡서로56',
    iwContent:
  ...
  { title: '장애여성 인력개발센터<br>(귀뚜라미홈시스텔 2층)', address: '서울특별시 강서구 화곡로 346',
    iwContent:
  ...
  { title: '메리워드지역아동센터<br>(동부골드아파트210동 관리동3층)', address: '서울특별시 구로구 고척로49 ',
    iwContent:
  ...
  { title: '구로파랑새지역아동센터<br>(3층)', address: '서울특별시 구로구 구로동로 38길 32',
    iwContent:
  ...
  { title: '꿈나래지역아동센터<br>(3층)', address: '서울특별시 구로구 고척로6길 29',
    iwContent:
      '<a href="https://www.xn--2z1bw8k1pjz5ccumkb.kr/edc/crse/plcdtl.do?&sch_edc_place_id=20210000093" style="color:blue" target="_blank">교육신청</a>'
 },
...
https://www.xn--2z1bw8k1pjz5ccumkb.kr/edc/crse/plcdtl.do?&sch_edc_place_id=20210001345" style="color:blue" target="_blank">교육신청</a>'
  ...
  { title: '양천구50플러스센터<br>(행정복합타운 4층)', address: '서울특별시 양천구 남부순환로 83길 53',
    iwContent:
  ...
  { title: '시니어행복발전센터<br>(대림1동 보건소분소 2층)', address: '서울특별시 영등포구 디지털로 441',
    iwContent:
  ...
  { title: '영등포동자치회관<br>(2층)', address: '서울특별시 영등포구 국회대로 44길 4',
    iwContent:
  ...
  { title: '양평2동 주민센터<br>(양평2동 주민센터 4층 프로그램실)', address: '서울특별시 영등포구 선유로47길 30',
    iwContent:
